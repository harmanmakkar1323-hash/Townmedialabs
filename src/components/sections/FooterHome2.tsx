      ...
      <ul className="space-y-0.5">
        {links.map((link) => (
          <li key={link.label}>
            <Link
              href={link.href}
              className="text-[13px] text-white hover:text-white transition-colors block py-1.5"
            >
              {link.label}
            </Link>
          </li>
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
              ...
              >
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="relative w-full bg-white/[0.04] border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-white placeholder:text-white focus:outline-none focus:border-[#ff4500]/40 transition-colors"
                  />
                </div>
                <button
                  type="submit"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 gap-x-8 gap-y-6">
                  ...
                  <ul className="space-y-0">
                    {group.cities.map((city) => (
                      <li key={city.label}>
                        <Link
                          href={city.href}
                          className="text-[13px] text-white hover:text-white transition-colors block py-1"
                        >
                          {city.label}
                        </Link>
                      </li>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 flex h-11 w-11 md:h-10 md:w-10 items-center justify-center rounded-full border border-white/[0.08] bg-[#080808]/80 backdrop-blur-sm text-white hover:text-white hover:border-[#ff4500]/30 transition-colors"
