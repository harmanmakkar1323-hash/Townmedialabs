...
const headingVariants: Record<SectionKey, string[]> = {
  whyChoose: [
    "Why {city} businesses choose our {service} company",
    "What makes us the best {service} agency in {city}",
    "Why our {service} services work differently in {city}",
    "The {city} advantage: top {service} company",
    "How our {service} agency delivers results in {city}",
    "{city}'s most trusted {service} company",
    "Why {city} companies choose our {service} services",
    "Best {service} agency in {city} — here's why",
  ],
  process: [
    "Our {service} agency process in {city}",
    "How our {service} company works in {city}",
    "From strategy to results: {service} services in {city}",
    "Our proven {service} process for {city} businesses",
    "{service} services — step by step in {city}",
    "How our {service} company approaches {city} projects",
    "The {service} process behind every {city} campaign",
    "How our {service} agency in {city} gets results",
  ],
  services: [
    "Our {service} services in {city}",
    "{service} services tailored for {city} businesses",
    "What our {service} company covers in {city}",
    "Full-scope {service} services for {city}",
    "{service} company capabilities in {city}",
    "Complete {service} services for {city} businesses",
    "Core {service} services we offer in {city}",
    "How our {service} services help {city} businesses grow",
  ],
  trust: [
    "Top-rated {service} company in {city}",
    "Why {city} brands trust our {service} agency",
    "Proven {service} results for {city} companies",
    "Best {service} company reviews from {city} businesses",
    "Trusted {service} agency — our {city} track record",
    "{city} businesses rely on our {service} services",
    "Rated best {service} company in {city}",
    "Leading {service} agency serving {city}",
  ],
  pricing: [
    "{service} services pricing in {city}",
    "What {service} services cost in {city}",
    "{service} company pricing for {city} businesses",
    "Affordable {service} services in {city}",
    "Your {service} investment in {city}",
    "How much do {service} services cost in {city}?",
    "{service} packages for {city} companies",
    "Budget-friendly {service} agency in {city}",
  ],
  industries: [
    "Industries our {service} company serves in {city}",
    "{city} industries we offer {service} services to",
    "Sectors powered by our {service} agency in {city}",
    "{service} services for every {city} industry",
    "Who our {service} company helps in {city}",
    "{service} industry expertise in {city}",
    "{city} sectors that trust our {service} services",
    "{service} agency for retail, tech & more in {city}",
  ],
  faq: [
    "{service} services in {city} — FAQs",
    "Common {service} company questions from {city}",
    "Frequently asked about {service} agencies in {city}",
    "{service} services in {city}: your questions answered",
    "What {city} clients ask about our {service} company",
    "{city} {service} agency FAQ",
    "Questions about {service} services in {city}?",
    "Everything about {service} companies in {city}",
  ],
  seoContent: [
    "Comprehensive {service} services for {city} businesses",
    "Grow your {city} business with expert {service} services",
    "The complete guide to {service} agencies in {city}",
    "How {service} services transform {city} businesses",
    "Everything {city} businesses need from a {service} company",
    "Professional {service} company for {city} brands",
    "Why {city} businesses invest in {service} services",
    "Expert {service} agency for {city} — full guide",
  ],
  otherServices: [
    "Other services our {city} agency offers",
    "More ways our company helps {city} businesses",
    "Explore our full {city} service offering",
    "Beyond {service}: other services in {city}",
    "Additional services for {city} companies",
    "Complete digital marketing services in {city}",
  ],
  whyNeed: [
    "Why your business needs {service} services in {city}",
    "Does your {city} business need a {service} company?",
    "The case for {service} services in {city}",
    "Why {service} services matter for {city} companies",
    "How {service} agencies drive growth in {city}",
    "Is a {service} company worth it in {city}?",
    "What happens without {service} services in {city}",
    "The ROI of hiring a {service} agency in {city}",
  ],
  charges: [
    "{service} agency charges in {city}",
    "What does a {service} company cost in {city}?",
    "{service} services pricing breakdown for {city}",
    "Understanding {service} agency fees in {city}",
    "Our {service} company rates for {city} businesses",
    "How {service} agencies price services in {city}",
  ],
};
