...
function generateH1(
  ...
  const shared = [
    ...
    `${serviceName} Experts Serving ${cityName}, ${state}`,
    `High-Performance ${serviceName} for ${cityName}`,
    `Scalable ${serviceName} Solutions in ${cityName}`,
    `${cityName} Businesses Trust Us for ${serviceName}`,
    `Your ${serviceName} Growth Partner in ${cityName}`,
  ];
  ...
  const countryPatterns: Record<CountryPool, string[]> = {
    india: [
      ...
      `Premier ${serviceName} Company in ${cityName}, ${state}`,
      `${cityName}'s Most Trusted ${serviceName} Agency`,
      `Best ${serviceName} Services in ${cityName}`,
      `Proven ${serviceName} Agency for ${cityName} Businesses`,
      `End-to-End ${serviceName} for ${cityName} Brands`,
    ],
    usa: [
      `Top-Rated ${serviceName} Agency for ${cityName} Businesses`,
      `#1 ${serviceName} Agency in ${cityName}, ${state}`,
      `${cityName}'s Top-Rated ${serviceName} Experts`,
      `Best-in-Class ${serviceName} for ${cityName}`,
      `ROI-Focused ${serviceName} Agency in ${cityName}`,
      `Enterprise-Grade ${serviceName} in ${cityName}`,
    ],
    uk: [
      `Award-Winning ${serviceName} in ${cityName}`,
      `Trusted ${serviceName} Agency in ${cityName}, ${state}`,
      `${cityName}'s Award-Winning ${serviceName} Specialists`,
      `Bespoke ${serviceName} for ${cityName} Businesses`,
      `${serviceName} Consultancy for ${cityName} Brands`,
      `Specialist ${serviceName} Agency in ${cityName}`,
    ],
    australia: [
      `Top ${serviceName} Agency in ${cityName}`,
      `${cityName}'s Leading ${serviceName} Specialists`,
      `Trusted ${serviceName} Solutions Across ${state}`,
      `${serviceName} Agency Powering ${cityName} Growth`,
      `Premium ${serviceName} for ${cityName} Brands`,
      `Performance-Driven ${serviceName} in ${cityName}`,
    ],
    uae: [
      `Premium ${serviceName} Agency in ${cityName}`,
      `${cityName}'s Elite ${serviceName} Partner`,
      `World-Class ${serviceName} in ${cityName}`,
      `Luxury ${serviceName} Solutions for ${cityName}`,
      `${serviceName} Excellence in ${cityName}`,
      `International ${serviceName} Agency in ${cityName}`,
    ],
    nz: [
      `Top ${serviceName} Agency in ${cityName}`,
      `${cityName}'s Trusted ${serviceName} Specialists`,
      `Leading ${serviceName} Solutions in ${state}`,
      `Innovative ${serviceName} for ${cityName} Brands`,
      `${serviceName} That Works for ${cityName} Businesses`,
      `Results-First ${serviceName} in ${cityName}`,
    ],
    canada: [
      `Top-Rated ${serviceName} Agency in ${cityName}`,
      `${cityName}'s Trusted ${serviceName} Experts`,
      `Leading ${serviceName} Agency Across ${state}`,
      `Professional ${serviceName} Partner in ${cityName}`,
      `${serviceName} Solutions Built for ${cityName}`,
      `Performance ${serviceName} Agency in ${cityName}`,
    ],
  };
