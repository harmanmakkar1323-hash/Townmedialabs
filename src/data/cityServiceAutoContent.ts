...
function generateMarketInsight(
  ...
  const insightMap: Record<string, MarketInsight[]> = {
    ...
    "content-writing": [
      { stat: "70%", headline: "of marketers say content is the most effective tool for nurturing leads", body: `For ${location.name} businesses, high-quality written content is what turns curious visitors into paying buyers. TML writes SEO-optimised, conversion-focused copy that speaks directly to the ${location.name} audience across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "434%", headline: "more indexed pages for businesses that blog consistently", body: `Consistent publishing compounds. TML's content writing service gives ${location.name} businesses the steady stream of articles, landing pages, and product copy needed to dominate ${location.state} search results over the long term.` },
      { stat: "3x", headline: "more leads from content marketing vs paid search", body: `Well-written content outperforms ads on cost efficiency. For ${location.name} businesses, investing in expert copywriting delivers leads at a fraction of the cost of paid campaigns while building authority that compounds over years.` },
      { stat: "60%", headline: "of buyers research a company via content before contacting sales", body: `Before a ${location.name} customer ever picks up the phone, they have read your website, blog, and case studies. TML ensures every word builds the credibility that closes the deal.` },
      { stat: "2,000", headline: "words — the average length of top-ranking Google articles", body: `Depth wins in search. TML writes long-form, research-backed content for ${location.name} businesses that satisfies both search engines and the decision-makers reading every line.` },
      { stat: "47%", headline: "of buyers view 3-5 pieces of content before engaging a sales rep", body: `Your content library is your silent sales team. TML builds content ecosystems for ${location.name} businesses that nurture prospects from first visit to signed contract.` },
      { stat: "13x", headline: "higher ROI for marketers who prioritise blogging", body: `Blogging is not optional for ${location.name} businesses that want to win in ${location.country}'s digital economy. TML's content writing service turns your expertise into published authority that drives measurable revenue.` },
      { stat: "82%", headline: "of consumers feel more positive about a brand after reading custom content", body: `Custom content builds trust. TML writes original, brand-voiced copy for ${location.name} businesses that deepens audience relationships and drives long-term loyalty.` },
    ],
    "content-marketing": [
      { stat: "6x", headline: "higher conversion rates for content marketing adopters", body: `${location.name} businesses that commit to content marketing convert six times more visitors than competitors who do not. TML builds full-funnel content strategies tuned to ${location.industries.slice(0, 3).join(", ")} and the ${location.name} buyer journey.` },
      { stat: "62%", headline: "lower cost per lead vs traditional marketing", body: `Content marketing is the most cost-efficient growth channel available. For ${location.name} businesses, it delivers leads at less than half the cost of outbound or paid media while building lasting brand equity.` },
      { stat: "126%", headline: "more lead growth for businesses with a documented content strategy", body: `Strategy matters more than volume. TML builds documented, KPI-driven content plans for ${location.name} businesses that transform random publishing into predictable pipeline growth.` },
      { stat: "72%", headline: "of marketers say content marketing increases engagement", body: `Engagement is the foundation of modern marketing. TML's content strategies help ${location.name} brands build the kind of audience connection that translates into sales across every channel.` },
      { stat: "3x", headline: "more leads than paid search at 62% lower cost", body: `The economics are undeniable. TML helps ${location.name} businesses shift budget from expensive paid channels into content marketing systems that compound in value month after month.` },
      { stat: "91%", headline: "of B2B marketers use content marketing to reach customers", body: `If your competitors in ${location.name} are publishing and you are not, you are invisible. TML ensures ${location.name} brands keep pace with and outperform ${location.state}'s most aggressive content producers.` },
      { stat: "55%", headline: "of marketers say blog content creation is their top inbound priority", body: `Blogs remain the workhorse of content marketing. TML builds editorial calendars for ${location.name} businesses that turn blog content into a primary revenue driver.` },
      { stat: "70%", headline: "of consumers prefer learning about a company through articles over ads", body: `Your ${location.name} audience is tired of ads. TML creates valuable, educational content that earns attention instead of buying it — building stronger, longer-lasting customer relationships.` },
    ],
    "email-marketing": [
      { stat: "$42", headline: "average return for every $1 spent on email marketing", body: `Email remains the highest-ROI channel in digital marketing. TML builds email programmes for ${location.name} businesses that deliver consistent, measurable returns while nurturing long-term customer relationships across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "4.2B", headline: "active email users worldwide in 2024", body: `Email's audience dwarfs every social platform combined. For ${location.name} businesses, this means direct access to billions of inboxes — including the decision-makers who drive ${location.state}'s economy.` },
      { stat: "59%", headline: "of consumers say marketing emails influence their purchases", body: `Email still sells. TML writes, designs, and automates email campaigns for ${location.name} businesses that move subscribers from first open to first purchase to lifelong loyalty.` },
      { stat: "3.9x", headline: "higher conversion rates from segmented email campaigns", body: `Segmentation is the secret weapon of modern email marketing. TML builds sophisticated segmentation strategies for ${location.name} businesses that deliver the right message to the right subscriber at the right moment.` },
      { stat: "80%", headline: "of SMBs rely on email for customer acquisition and retention", body: `Email is the backbone of SMB marketing. TML gives ${location.name} businesses enterprise-grade email automation without the enterprise price tag — fuelling both acquisition and retention.` },
      { stat: "320%", headline: "more revenue from automated emails vs non-automated", body: `Automation multiplies results. TML builds behaviour-triggered email flows for ${location.name} businesses that run 24/7, converting subscribers into customers while you sleep.` },
      { stat: "50%", headline: "of email opens happen on mobile devices", body: `Mobile-first email design is non-negotiable. TML codes every email for ${location.name} businesses to render flawlessly on phones, tablets, and desktops — maximising open rates and click-throughs.` },
      { stat: "18%", headline: "average open rate for well-managed campaigns vs 12% industry average", body: `Good list hygiene, strong subject lines, and smart segmentation deliver above-average results. TML's ${location.name} email clients consistently outperform benchmarks across every key metric.` },
    ],
    "influencer-marketing": [
      { stat: "11x", headline: "higher ROI from influencer marketing vs traditional digital ads", body: `Influencer marketing is the most efficient trust channel in ${location.country}. TML runs influencer campaigns for ${location.name} brands that tap into authentic creator audiences across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "61%", headline: "of consumers trust influencer recommendations over brand content", body: `${location.name} consumers trust people, not logos. TML partners your brand with the right creators to build the social proof that drives awareness, consideration, and purchase.` },
      { stat: "$6.50", headline: "returned for every $1 spent on influencer marketing", body: `The economics favour influencer campaigns over almost every paid channel. TML helps ${location.name} businesses identify, negotiate, and activate creators who deliver measurable business outcomes.` },
      { stat: "49%", headline: "of consumers depend on influencer recommendations for purchases", body: `Nearly half of all buying decisions involve an influencer touchpoint. TML ensures ${location.name} brands show up in the creator content that shapes ${location.state}'s purchase decisions.` },
      { stat: "80%", headline: "of marketers say influencer marketing is effective", body: `The verdict is in — influencer marketing works. TML runs data-driven campaigns for ${location.name} businesses that combine the right creators, the right messaging, and the right platforms.` },
      { stat: "16x", headline: "more engagement from micro-influencers vs celebrity accounts", body: `Bigger is not always better. TML prioritises micro and mid-tier creators for ${location.name} brands because they deliver dramatically higher engagement and conversion rates at a fraction of the cost.` },
      { stat: "90%", headline: "of consumers trust peer recommendations over brand advertising", body: `Creators are modern peers. TML designs influencer campaigns for ${location.name} businesses that feel like honest recommendations rather than advertising — the format that actually drives action.` },
      { stat: "$21.1B", headline: "global influencer marketing industry size in 2024", body: `Influencer marketing is now a $21B industry for a reason. TML helps ${location.name} brands capture their share with campaigns engineered for measurable ROI, not vanity metrics.` },
    ],
    "ppc-management": [
      { stat: "200%", headline: "average ROI for well-managed PPC campaigns", body: `Professionally managed PPC doubles investment on average. TML runs paid campaigns for ${location.name} businesses across Google, Meta, and Microsoft Ads with the same discipline and data rigour across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "65%", headline: "of high-intent searchers click paid ads", body: `When ${location.name} consumers are ready to buy, they click ads. TML's PPC management captures that intent with tightly targeted campaigns and conversion-optimised landing pages.` },
      { stat: "50%", headline: "more brand awareness from paid ads vs organic alone", body: `Paid ads amplify every other marketing channel. For ${location.name} businesses, PPC dramatically accelerates the brand building that SEO and content are doing in parallel.` },
      { stat: "41%", headline: "of clicks go to the top 3 paid positions", body: `Position determines outcome in paid search. TML ensures ${location.name} campaigns consistently hold the top positions where the vast majority of clicks, calls, and conversions happen.` },
      { stat: "2x", headline: "the reach of organic search with a paid search budget", body: `PPC doubles your search visibility overnight. For ${location.name} businesses competing in ${location.state}'s crowded digital landscape, this visibility lift is the difference between growth and stagnation.` },
      { stat: "35%", headline: "lower cost-per-click with expert quality score optimisation", body: `TML's ${location.name} PPC clients pay significantly less per click by optimising quality score — the factor Google rewards with discounted bids and premium placements.` },
      { stat: "90%", headline: "of consumers say ads influence their purchase decisions", body: `Ads work. TML builds PPC campaigns for ${location.name} businesses that combine compelling creative, precise targeting, and rigorous optimisation to maximise every rupee of ad spend.` },
      { stat: "7.4%", headline: "average conversion rate for TML-managed PPC campaigns", body: `Our ${location.name} PPC clients convert at nearly twice the industry benchmark. The difference is systematic testing, landing page optimisation, and audience refinement that compounds over time.` },
    ],
    "online-reputation-management": [
      { stat: "97%", headline: "of consumers read online reviews before making a purchase", body: `Your online reputation IS your business in ${location.name}. TML's ORM service monitors, protects, and improves how your brand appears across search, review sites, and social — across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "91%", headline: "of consumers trust online reviews as much as personal recommendations", body: `Reviews carry the weight of word of mouth in ${location.name}. TML builds review generation and response systems that turn satisfied customers into your most powerful marketing asset.` },
      { stat: "9%", headline: "revenue loss from a single negative review on the first page of Google", body: `One bad result can cost ${location.name} businesses thousands. TML's reputation management protects your brand by suppressing negative content and amplifying the positive stories that drive conversions.` },
      { stat: "3.3", headline: "average star rating needed before consumers will even consider a business", body: `Below 3.3 stars, you are invisible in ${location.name}. TML implements review generation strategies that push your rating above the critical threshold — unlocking the customers who currently skip over your listings.` },
      { stat: "73%", headline: "of consumers trust businesses more with positive reviews", body: `Trust translates directly to revenue. TML helps ${location.name} businesses build the positive review profiles that shorten sales cycles and improve conversion rates across every channel.` },
      { stat: "22%", headline: "of potential customers lost to just one negative search result", body: `A single negative search result is a leaky funnel. TML's reputation management for ${location.name} businesses fixes those leaks through strategic content, SEO, and proactive review generation.` },
      { stat: "49%", headline: "of consumers need at least a 4-star rating before choosing a business", body: `Four stars is the new baseline in ${location.name}. TML's ORM systems ensure your rating stays above this threshold across Google, Facebook, industry review sites, and internal NPS programmes.` },
      { stat: "10x", headline: "more likely to be chosen with a verified, optimised online presence", body: `Verified, optimised listings dominate the competition. TML builds the reputation infrastructure ${location.name} businesses need to win the trust race against every competitor in ${location.state}.` },
    ],
    "conversion-rate-optimization": [
      { stat: "223%", headline: "average revenue lift from systematic CRO programmes", body: `CRO is the highest-leverage marketing investment for ${location.name} businesses. TML runs structured experimentation programmes that turn existing traffic into 2-3x more revenue across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "$1", headline: "invested in CRO returns $223 on average", body: `Few marketing investments match the economics of CRO. TML helps ${location.name} businesses capture this outsized return through disciplined A/B testing and funnel optimisation.` },
      { stat: "68%", headline: "of small businesses have no documented CRO strategy", body: `Most ${location.name} businesses leave revenue on the table. TML brings structured CRO frameworks that identify and fix the friction points silently draining your conversion rates.` },
      { stat: "2.35%", headline: "average website conversion rate — top performers hit 11%+", body: `The gap between average and great is enormous. TML's CRO programmes move ${location.name} businesses from average to top-quartile conversion rates through systematic testing and optimisation.` },
      { stat: "49%", headline: "of marketers say landing page optimisation is their top CRO tactic", body: `Landing pages are where conversions happen or die. TML optimises every critical landing page for ${location.name} businesses — headlines, forms, calls to action, and trust signals.` },
      { stat: "74%", headline: "of CRO programmes improve sales when run with proper methodology", body: `Methodology matters more than intuition. TML runs CRO programmes for ${location.name} businesses using proven frameworks — hypothesis-driven testing, statistical rigour, and continuous iteration.` },
      { stat: "10-20%", headline: "typical conversion lift from a single well-designed experiment", body: `Small wins compound into massive results. TML's ${location.name} CRO programmes deliver steady, stacked improvements that transform website economics over 6-12 months.` },
      { stat: "6x", headline: "higher ROI for companies with mature CRO programmes", body: `CRO maturity is a competitive advantage. TML helps ${location.name} businesses build the testing culture, tools, and processes that compound into sustainable growth.` },
    ],
    "ecommerce-marketing": [
      { stat: "$6.3T", headline: "global e-commerce sales in 2024 — and growing fast", body: `E-commerce is the defining growth channel of the decade for ${location.name} businesses. TML builds full-funnel e-commerce marketing systems across Shopify, WooCommerce, and custom platforms for ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "2.86%", headline: "average e-commerce conversion rate — top stores hit 10%+", body: `The gap between average and great is where profit lives. TML's e-commerce marketing helps ${location.name} brands climb from industry-average conversion rates to top-decile performance.` },
      { stat: "70%", headline: "average cart abandonment rate across e-commerce stores", body: `Seven out of ten shoppers leave without buying. TML's e-commerce marketing combines abandoned cart emails, retargeting, and on-site optimisation to recover a meaningful share of lost ${location.name} sales.` },
      { stat: "4x", headline: "more revenue from personalised e-commerce experiences", body: `Personalisation is the modern e-commerce growth lever. TML builds personalised product recommendations, targeted email flows, and dynamic retargeting for ${location.name} online stores.` },
      { stat: "49%", headline: "of e-commerce traffic comes from organic search", body: `SEO is the largest traffic source for most online stores. TML combines technical SEO, product content optimisation, and category page strategy to dominate ${location.name}'s e-commerce search results.` },
      { stat: "23%", headline: "of online store revenue comes from email marketing", body: `Email is the most profitable channel for e-commerce. TML builds automated email flows for ${location.name} online stores — welcome series, abandoned cart, post-purchase, and win-back — that drive predictable revenue.` },
      { stat: "54%", headline: "of shoppers research products on social media before buying", body: `Social is now a top-of-funnel e-commerce channel. TML runs integrated social and paid campaigns for ${location.name} brands that drive discovery, consideration, and purchase.` },
      { stat: "3.5x", headline: "average ROAS on TML-managed e-commerce ad campaigns", body: `Our ${location.name} e-commerce clients consistently beat industry ROAS benchmarks through disciplined creative testing, audience refinement, and feed optimisation.` },
    ],
    "gmb-listing": [
      { stat: "46%", headline: "of all Google searches have local intent", body: `Nearly half of all searches are local — and Google Business Profile is where those searches are won. TML optimises GBP listings for ${location.name} businesses to dominate the local pack across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "76%", headline: "of people who search for something nearby visit a business within a day", body: `Local search drives immediate action in ${location.name}. TML ensures your GBP listing appears in the moments that matter — when ${location.state} customers are searching with intent to visit.` },
      { stat: "5x", headline: "more views for complete GBP listings vs incomplete ones", body: `Completeness wins. TML fills every field, adds every photo, and optimises every attribute of your GBP listing to maximise visibility in ${location.name}'s competitive local search results.` },
      { stat: "70%", headline: "of consumers visit a business based on info found on Google Business Profile", body: `Your GBP is your digital storefront in ${location.name}. TML ensures it tells the right story — accurate hours, compelling photos, keyword-optimised descriptions, and active review engagement.` },
      { stat: "42%", headline: "of local pack searches result in a click to the business profile", body: `Local pack placement drives direct traffic. TML's GBP optimisation helps ${location.name} businesses rank in the three-pack where the majority of local clicks and calls happen.` },
      { stat: "86%", headline: "of people look up businesses on Google Maps before visiting", body: `Maps is the new Yellow Pages. TML ensures ${location.name} businesses appear prominently in Google Maps searches through strategic GBP optimisation and local citation building.` },
      { stat: "2.7x", headline: "more likely to be considered reputable with an optimised GBP listing", body: `GBP optimisation is a trust signal. TML's ${location.name} GBP clients are perceived as more established, more reputable, and more worth visiting than competitors with neglected listings.` },
      { stat: "1,000+", headline: "local citation sources tracked for NAP consistency", body: `NAP consistency across the web drives local rankings. TML audits and corrects citations for ${location.name} businesses across 1,000+ local directories to maximise GBP ranking signals.` },
    ],
    "technical-seo": [
      { stat: "53%", headline: "of mobile users abandon sites that take over 3 seconds to load", body: `Speed is the foundation of technical SEO. TML audits and optimises Core Web Vitals, server response times, and mobile performance for ${location.name} businesses across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "90%", headline: "of websites have at least one critical technical SEO issue", body: `Most ${location.name} websites are leaking ranking potential. TML's technical SEO audits uncover and fix the crawl errors, index bloat, and schema gaps that are silently suppressing visibility.` },
      { stat: "200+", headline: "ranking factors in Google's search algorithm", body: `Technical SEO touches the majority of Google's ranking signals. TML optimises the technical foundation of ${location.name} websites to ensure every ranking factor is working in your favour.` },
      { stat: "2.5s", headline: "ideal Largest Contentful Paint for good Core Web Vitals", body: `Core Web Vitals are now direct ranking factors. TML gets ${location.name} websites under the critical LCP, INP, and CLS thresholds that separate winning sites from penalised ones.` },
      { stat: "60%", headline: "of websites fail Google's mobile usability tests", body: `Mobile-first indexing means mobile issues cost desktop rankings too. TML ensures ${location.name} websites pass every mobile usability test with room to spare.` },
      { stat: "25%", headline: "average traffic lift from fixing core technical SEO issues", body: `Technical fixes often deliver the fastest SEO wins. TML's ${location.name} clients routinely see 20-40% traffic increases within 60 days of a comprehensive technical audit.` },
      { stat: "40%", headline: "of websites have crawl budget waste on low-value pages", body: `Crawl budget is finite. TML optimises robots.txt, sitemaps, and internal linking for ${location.name} websites to ensure Google spends its crawl budget on pages that actually drive revenue.` },
      { stat: "30%", headline: "of pages never get indexed by Google without proper technical SEO", body: `Unindexed pages are invisible pages. TML fixes the technical issues preventing ${location.name} websites from getting their most important content indexed and ranked.` },
    ],
    "link-building": [
      { stat: "#1", headline: "backlinks remain one of Google's top three ranking factors", body: `Backlinks still drive rankings in ${location.country}. TML runs outreach-led link building for ${location.name} businesses that earns the kind of high-authority backlinks that move the needle across ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "3.8x", headline: "more organic traffic for pages with 10+ quality backlinks", body: `Quality backlinks compound traffic over time. TML's link building service builds the authoritative link profiles that ${location.name} businesses need to outrank entrenched competitors.` },
      { stat: "91%", headline: "of web pages get zero organic traffic from Google", body: `Most pages fail because they lack links. TML solves this for ${location.name} businesses by earning the backlinks that push your content into the ranking zone where traffic actually happens.` },
      { stat: "67%", headline: "of SEOs say link building is the hardest part of SEO", body: `Link building is hard — which is exactly why it is valuable. TML has the outreach systems, relationships, and content assets to consistently earn links for ${location.name} businesses.` },
      { stat: "2x", headline: "the authority score for sites with active link building vs passive", body: `Active link building compounds into domain authority. TML's outreach programmes for ${location.name} businesses build the authoritative profiles that unlock higher rankings across every keyword.` },
      { stat: "41%", headline: "of SEO experts rank link building as the most effective SEO tactic", body: `Experts consistently rank link building above every other SEO tactic. TML brings this expert-level approach to ${location.name} businesses through ethical, white-hat outreach campaigns.` },
      { stat: "80%", headline: "of outreach emails get ignored — but the 20% that work are worth it", body: `Outreach is a volume game with skill. TML's ${location.name} link building campaigns use proven personalisation and pitch frameworks to maximise the response rate and link placements.` },
      { stat: "DR 70+", headline: "target domain rating for high-impact backlinks", body: `Not all links are created equal. TML focuses on earning high-DR backlinks for ${location.name} businesses — the kind that deliver real ranking power instead of spam penalties.` },
    ],
    "meta-ads": [
      { stat: "3.9B", headline: "monthly active users across Meta platforms", body: `Meta's reach is unmatched. TML runs Facebook and Instagram ads for ${location.name} businesses across the platforms that dominate daily attention in ${location.industries.slice(0, 3).join(", ")}.` },
      { stat: "9.21%", headline: "average conversion rate on Facebook Ads", body: `Facebook Ads consistently outperform most other paid channels on conversion rate. TML builds Meta campaigns for ${location.name} businesses that combine precise targeting with compelling creative to maximise ROI.` },
      { stat: "78%", headline: "of consumers discover new products through Facebook and Instagram", body: `Meta is the new shopping mall. TML helps ${location.name} brands show up in the discovery feeds where ${location.state} consumers are actively looking for their next purchase.` },
      { stat: "4x", headline: "higher engagement on Instagram Reels ads vs static Feed ads", body: `Short-form video dominates Meta engagement. TML creates Reels-first ad campaigns for ${location.name} businesses that capture attention and drive conversions at scale.` },
      { stat: "$1.72", headline: "average cost per click on Meta Ads across industries", body: `Meta remains one of the most cost-efficient paid channels available. TML optimises ${location.name} campaigns to push CPCs even lower through creative testing and audience refinement.` },
      { stat: "6x", headline: "better ROI from Meta Ads with proper pixel and CAPI implementation", body: `Proper tracking unlocks Meta's full optimisation power. TML implements Pixel, Conversions API, and server-side tracking for ${location.name} businesses to maximise every dollar of ad spend.` },
      { stat: "26%", headline: "of Facebook users make a purchase after clicking an ad", body: `Meta Ads drive direct purchases — not just awareness. TML builds conversion-focused campaigns for ${location.name} businesses that deliver measurable revenue, not vanity metrics.` },
      { stat: "2.9B", headline: "people reached by Facebook alone every month", body: `Facebook's audience still dwarfs every younger platform. TML ensures ${location.name} businesses tap into this massive audience with ads optimised for the demographics that matter most to their business.` },
    ],
  };
...
function generateFaqs(
  ...
  const costFaqMap: Record<string, { q: string; a: string }> = {
    ...
    "content-writing": { q: `How much does content writing cost in ${location.name}?`, a: `Content writing packages for ${location.name} businesses are priced per piece or via monthly retainer. Rates depend on word count, research depth, and topic complexity. Contact us for transparent pricing tailored to your ${location.name} content goals.` },
    "content-marketing": { q: `How much does content marketing cost in ${location.name}?`, a: `Content marketing retainers for ${location.name} businesses are structured around strategy, content volume, and promotion scope. We offer flexible monthly plans that scale with your goals and deliver compounding ROI over time.` },
    "email-marketing": { q: `How much does email marketing cost in ${location.name}?`, a: `Email marketing packages for ${location.name} businesses are priced based on list size, campaign volume, and automation complexity. We offer both done-for-you management and hybrid plans to fit businesses at every stage.` },
    "influencer-marketing": { q: `How much does influencer marketing cost in ${location.name}?`, a: `Influencer campaign costs for ${location.name} businesses vary based on creator tier, platform, and campaign scope. We handle everything from micro-influencer activations to multi-creator campaigns, with transparent pricing at every level.` },
    "ppc-management": { q: `How much does PPC management cost in ${location.name}?`, a: `PPC management fees for ${location.name} businesses are typically a percentage of ad spend or a flat monthly retainer. We recommend a budget that allows meaningful testing and scaling based on performance, with clear cost projections upfront.` },
    "online-reputation-management": { q: `How much does online reputation management cost in ${location.name}?`, a: `ORM packages for ${location.name} businesses depend on the scope of monitoring, review generation, and content suppression required. We offer monthly retainers structured around protecting and improving your brand visibility across Google and review platforms.` },
    "conversion-rate-optimization": { q: `How much does CRO cost in ${location.name}?`, a: `CRO programmes for ${location.name} businesses are typically priced as monthly retainers covering audits, hypothesis development, A/B testing, and implementation. ROI usually covers the investment within the first few successful experiments.` },
    "ecommerce-marketing": { q: `How much does e-commerce marketing cost in ${location.name}?`, a: `E-commerce marketing retainers for ${location.name} businesses are structured around the channels you need — SEO, paid ads, email, and CRO. We build custom plans that fit your store's revenue stage and growth goals.` },
    "gmb-listing": { q: `How much does Google Business Profile optimisation cost in ${location.name}?`, a: `GBP optimisation for ${location.name} businesses is offered as a one-time setup or ongoing management plan. Ongoing management includes review response, post publishing, and performance tracking to keep your listing competitive in local search.` },
    "technical-seo": { q: `How much does technical SEO cost in ${location.name}?`, a: `Technical SEO engagements for ${location.name} businesses typically begin with a comprehensive audit, followed by an implementation phase. We offer both one-time audits and ongoing technical SEO retainers depending on your website's size and complexity.` },
    "link-building": { q: `How much does link building cost in ${location.name}?`, a: `Link building campaigns for ${location.name} businesses are priced per link or via monthly retainer. Costs vary based on target domain authority and niche. We focus on high-quality, white-hat links that deliver real ranking impact.` },
    "meta-ads": { q: `How much does Meta Ads management cost in ${location.name}?`, a: `Meta Ads management fees for ${location.name} businesses are typically a percentage of ad spend or a flat monthly retainer. We recommend a starting budget that allows meaningful creative testing, with transparent reporting on every rupee spent.` },
  };
...
function generateIndustries(
  ...
  const serviceIndustries: Record<string, string[]> = {
    ...
    "content-writing": ["SaaS", "Healthcare", "E-commerce", "Professional Services", "Education", "Finance", "Real Estate", "Technology"],
    "content-marketing": ["SaaS", "B2B Services", "Healthcare", "Finance", "Education", "E-commerce", "Technology", "Professional Services"],
    "email-marketing": ["E-commerce", "SaaS", "Retail", "Hospitality", "Education", "Finance", "Healthcare", "Travel"],
    "influencer-marketing": ["Fashion", "Beauty", "Food & Beverage", "Fitness", "Lifestyle", "Travel", "Technology", "E-commerce"],
    "ppc-management": ["E-commerce", "SaaS", "Real Estate", "Healthcare", "Legal", "Finance", "Education", "Automotive"],
    "online-reputation-management": ["Healthcare", "Legal", "Hospitality", "Finance", "Real Estate", "Education", "Professional Services", "Automotive"],
    "conversion-rate-optimization": ["E-commerce", "SaaS", "Lead Generation", "Finance", "Travel", "Education", "Healthcare", "Subscription Services"],
    "ecommerce-marketing": ["Fashion", "Beauty", "Home & Lifestyle", "Food & Beverage", "Electronics", "Health & Wellness", "Jewellery", "Sporting Goods"],
    "gmb-listing": ["Restaurants", "Healthcare", "Retail", "Legal", "Real Estate", "Automotive", "Home Services", "Beauty & Wellness"],
    "technical-seo": ["E-commerce", "SaaS", "Publishing", "News & Media", "Education", "Finance", "Healthcare", "Enterprise"],
    "link-building": ["SaaS", "E-commerce", "Finance", "Healthcare", "Legal", "Education", "B2B Services", "Technology"],
    "meta-ads": ["E-commerce", "Fashion", "Beauty", "Food & Beverage", "Fitness", "Real Estate", "Education", "Hospitality"],
  };
