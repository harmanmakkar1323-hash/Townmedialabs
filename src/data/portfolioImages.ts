...
export const portfolioImages: PortfolioImage[] = [
  ...
  { src: "/work/product-photography-styled-still-life.png", alt: "Styled still life product photography — beauty and food composition", category: "product-photography" },
  { src: "/work/product-photography-fine-art.png", alt: "Fine art fashion photography — cinematic editorial composition", category: "product-photography" },
  { src: "/work/product-photography-jewelry.png", alt: "Jewelry product photography — diamond pendant on citrus slices", category: "product-photography" },
  { src: "/work/product-photography-handbag-sunset.png", alt: "Fashion product photography — designer handbag at sunset", category: "product-photography" },
  { src: "/work/product-photography-cinematic-portrait.png", alt: "Cinematic brand portrait photography — lifestyle campaign", category: "product-photography" },
  { src: "/work/product-photography-food-croissant.png", alt: "Food photography — exploding chocolate croissant with dramatic lighting", category: "product-photography" },
  { src: "/work/product-photography-lipstick-beauty.png", alt: "Beauty product styling — lipstick and cherry creative composition", category: "product-photography" },
  { src: "/work/product-photography-fashion-editorial.png", alt: "Fashion editorial photography — studio portrait with dramatic lighting", category: "product-photography" },
  { src: "/work/product-photography-creative-closeup.png", alt: "Creative close-up product photography with artistic composition", category: "product-photography" },
  { src: "/work/product-photography-fashion-shoes.png", alt: "Fashion detail photography — velvet shoes with styled accessories", category: "product-photography" },
  { src: "/work/product-photography-cocktails.png", alt: "Beverage photography — artisan cocktails with premium styling", category: "product-photography" },
  { src: "/work/product-photography-fashion-night.png", alt: "Night fashion editorial — model walking on pier with dramatic lighting", category: "product-photography" },
  { src: "/work/product-photography-luxury-skincare.png", alt: "Luxury skincare product photography with dramatic shadow lighting", category: "product-photography" },
  ...
  { src: "/work/graphic-design-dental-creative.png", alt: "Dental brand creative advertising — bridge concept design", category: "graphic-design" },
  ...
  { src: "/work/graphic-design-illustration.png", alt: "Digital illustration — artistic portrait with vibrant colour palette", category: "graphic-design" },
  { src: "/work/graphic-design-retro-illustration.png", alt: "Retro editorial illustration — music performance artwork", category: "graphic-design" },
  ...
  { src: "/work/social-media-instagram-mockup.png", alt: "Instagram feed design mockup — cohesive visual identity for creative studio", category: "social-media" },
