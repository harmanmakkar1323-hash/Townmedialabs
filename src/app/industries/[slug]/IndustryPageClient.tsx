...
function PainPointCard({ point, index }: { point: string; index: number }) {
  return (
    <div
      className={`scroll-reveal scroll-delay-${index + 1} group relative p-6 md:p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] hover:bg-white/[0.04] hover:border-red-500/20 transition-all duration-500`}
    >
    ...
    <main className="bg-[#050505] text-white min-h-screen">
      ...
      <section className="hero-orange-gradient relative w-full px-6 pt-32 pb-16 md:pt-40 md:pb-24 lg:px-12 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <div
            className="hero-fade-up hero-delay-1 text-5xl md:text-6xl mb-6"
          >
            {industry.icon}
          </div>
        ...
        <section className="relative w-full px-6 py-16 md:py-24 lg:px-12 overflow-hidden">
          <div className="relative mx-auto max-w-4xl">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div className="scroll-reveal-scaleX flex-1 h-[1px] bg-white/[0.06] origin-left" />
            </div>
