...
export const metadata: Metadata = {
  ...
  description:
    "TML is the leading digital marketing agency in Chandigarh offering branding, SEO, Google Ads, social media marketing, web development, and more. 200+ brands served, 10+ years of experience.",
  keywords: [
