...
export const metadata: Metadata = {
  title: "Best Google Ads Agency in Queenstown",
  description: "Top-rated Google Ads company in Queenstown. TML offers expert Google Ads services for 500+ businesses. Get a free Google Ads consultation today.",
