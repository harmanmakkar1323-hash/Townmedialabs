...
export const metadata: Metadata = {
  title: "Best Google Ads Agency in Atlanta",
  description: "Top-rated Google Ads company in Atlanta. TML offers expert Google Ads services for 500+ businesses. Get a free Google Ads consultation today.",
