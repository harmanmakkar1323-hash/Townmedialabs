...
export const metadata: Metadata = {
  title: "Best Google Ads Agency in San Antonio",
  description: "Top-rated Google Ads company in San Antonio. TML offers expert Google Ads services for 500+ businesses. Get a free Google Ads consultation today.",
